(function(){
  var NAV_ITEMS_MAIN = [
    { key: 'overview',   href: 'index.html',      label: 'Overview',   icon: '<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>' },
    { key: 'statistics', href: 'statistics.html', label: 'Statistics', icon: '<path d="M4 20V10M10 20V4M16 20v-7M22 20H2"/>' },
    { key: 'metrics',    href: 'metrics.html',    label: 'Metrics',    icon: '<circle cx="9" cy="8" r="4"/><path d="M2 21c1-4 5-6 7-6s6 2 7 6M17 11a3 3 0 100-6M23 21c-.6-2.4-2.3-4-4-4.8"/>' },
    { key: 'stations',   href: 'stations.html',   label: 'Stations',   icon: '<path d="M3 21h18M5 21V10l7-6 7 6v11M9 21v-6h6v6"/>', badge: '2' },
    { key: 'uploads',    href: 'uploads.html',    label: 'Uploads',    icon: '<path d="M20 7h-6L12 5H4v14h16V7z"/>' },
    { key: 'alerts',     href: 'alerts.html',     label: 'Alerts',     icon: '<path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>', badge: '13' },
    { key: 'insights',   href: 'insights.html',   label: 'Insights',   icon: '<path d="M3 3h18v4H3zM3 10h18v4H3zM3 17h18v4H3z"/>' }
  ];
  var NAV_ITEMS_GENERAL = [
    { key: 'settings', href: 'settings.html', label: 'Settings', icon: '<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09a1.65 1.65 0 00-1-1.51 1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09a1.65 1.65 0 001.51-1 1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z" stroke-linecap="round" stroke-linejoin="round"/>' },
    { key: 'security', href: 'security.html', label: 'Security', icon: '<path d="M12 2l8 4v6c0 5-3.5 8.5-8 10-4.5-1.5-8-5-8-10V6z"/>' }
  ];
  ...
  function navLinkHtml(item, activeKey){
    ...
    return '<a' + cls + ' href="' + item.href + '"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">' + item.icon + '</svg>' + item.label + badge + '</a>';
  }
  ...
  function sidebarHtml(activeKey){
    ...
    return '' +
      ...
      '  <div>\n' +
      '    <div class="who" data-shell="profile-name">Owner Account</div>\n' +
      '    <div class="mail" data-shell="profile-email">hoanghuyho2810@gmail.com</div>\n' +
      '  </div>\n' +
      '  <button type="button" class="signout-btn" data-shell="signout" title="Sign out">\n' +
